          ...
          <table class="table table-bordered compactb table-condensed" style="width:100%; margin-bottom:4px">
            ...
            <form method="POST" id="formproveedor">
              <tr>  
                ...
                <input type="text" id="cod_proveedora" name="cod_proveedora" class="form-control input_tab no-padding control" style="padding:5px !important"></td>
                <td style="width:80px;" class="no-padding">
                ...
                <input type="text" id="desc_proveedora" name="desc_proveedora" class="form-control input_tab no-padding control" style="padding:5px !important"></td>
              </tr>
            </form>
            </tbody>
            <tfoot>
...
<div class="modal fade" id="ModalProveedor" tabindex="-1" role="dialog">
  <div class="modal-dialog" style="width:65%">
    <div class="box bg-gray-active">
      <div class="modal-content" style="border-radius:5px">
        <div class="modal-header" style="padding-bottom:0px">
          <h4 class="modal-title"> Seleccionar Proveedor 
          <button type="button" id="btnNuevoProveedor" class="btn btn-sm btn-primary pull-right">
          Nuevo Proveedor <i class="glyphicon glyphicon-user"></i></button></h4>
        </div>
        <div class="modal-body" style="padding:3px 5px;">
          <table id="tbproveedor" class="table compact table-bordered table-condensed table-hover table-dark table-responsive table-primary"           
          style="padding:0px; margin-bottom:2px; width:100%;">
            <thead class="bg-gray-active">
              ...
              <th style="text-align:center;" class="nd">Cond. de Pago</th>
            </thead>
          </table>
        </div>
        <div class="modal-footer">
    ...
    <div class="box box-primary">
        ...
        <div class="panel-body">
          <table class="table table-bordered compactb table-condensed" style="width:100%; margin-bottom:4px">
            ...
            <tbody>
              <tr>
                <td style="width:100px;" class="no-padding"><input type="text" id="cod_articulom" class="form-control input_tab no-padding control"></td>
                <td style="width:290px;" class="no-padding"><input type="text" id="desc_articulom" class="form-control input_tab no-padding control"></td>
                <td style="width:90px;" class="no-padding"><select id="idartunidad" class="form-control control input_tab no-padding"></select></td>
                <td style="width:80px;" class="no-padding"><input type="text" name="cantidadm" id="cantidadm" class="form-control input_tab text-right control" style="padding:0px 4px !important;"></td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
          ...
          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden">
            <input type="text" id="costom" class="control"> 
            <input type="text" id="tipom" class="control">
            <input type="text" id="tasam" class="control">
            <input type="text" id="stockm" class="control">
            <input type="" id="idarticulom" class="control">
      ...
      <div class="panel-body table-responsive">
        <table id="tbdocumento" class="table compact table-bordered table-condensed table-hover" style="width:100%;">
          <thead class="bg-blue">
            ...
            <th style="text-align:center; width:100px;" class="nd">Código</th>
            <th style="text-align:center; width:400px;" class="nd">Proveedor</th>
