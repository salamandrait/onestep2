         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Categorías </h1><br>
              ...
              <div class="panel-body table-responsive hidden" id="listadoregistros">
                <table id="tblistado" class="table compact table-striped table-bordered table-condensed table-hover table-responsive" style="width:100% !important;">
                  <thead class="bg-gray-active">
                    <th class="nd text-center" style="min-width:70px">Opciones</th>
                    <th class="text-center" style="min-width:120px">Código</th>
                    <th>Descripción</th>
                    <th class="nd text-center" style="min-width:70px">Estado</th>
                  </thead>
                </table>   
              </div>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    ...
                    <input type="textc" name="cod_categoria" id="cod_categoria" class="form-control" 
                  ...
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <input type="text" name="desc_categoria" id="desc_categoria" class="form-control" 
