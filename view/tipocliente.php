         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Tipos de Clientes </h1><br>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <label for="cod_tipocliente">Codigo:</label>
                    <input type="hidden" name="idtipocliente" id="idtipocliente">
                    <input type="textc" name="cod_tipocliente" id="cod_tipocliente" class="form-control" 
                  ...
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <input type="text" name="desc_tipocliente" id="desc_tipocliente" class="form-control" 
