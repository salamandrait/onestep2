         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Pedido de Venta </h1><br>
              ...
              <div class="panel-body table-responsive hidden" id="listadoregistros">
                <table id="tblistado" class="table compact table-striped table-bordered table-condensed table-hover" style="width:100% !important;">
                  <thead class="bg-gray-active">
                    ...
                    <th class=" text-center" style="width:100px">Pedido N°</th>
                    <th class="nv text-center" style="width:100px">N° Ctrl.</th>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <label for="cod_venta">Código:</label>
                    <b><input type="textc" name="cod_venta" id="cod_venta" class="form-control required" 
                  ...
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <input type="text" class="form-control ctrl" name="desc_cliente" id="desc_cliente" 
                    maxlength="250" placeholder="Cliente" disabled="disabled">
                  </div>
                  <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
                  ...
                  <div class="form-group col-lg-3 col-md-3 col-sm-8 col-xs-8">
                    <select name="selectcondpago" id="selectcondpago" class="form-control" disabled>
                    </select>
                  </div>
                  <div class="form-group col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    <div class="input-group">
                      <span class="input-group-addon"><label> Vendedor:</label></span>
                      <select name="selectvendedor" id="selectvendedor" class="form-control" disabled>
                      </select>
                    </div>
                  </div>
                  <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
                    <input type="text" name="numerod" id="numerod" class="form-control iop required" 
                    placeholder="N° de Pedido" required="required" readonly>
                  </div>
                  <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
                  ...
                  <div class="form-group col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <input text class="form-control iop" name="desc_venta" id="desc_venta" 
                  ...
                  <div class="panel-body table-responsive" style="padding:0px 15px 0px 15px;">
                      <table id="tbdetalles" class="table compact table-striped table-bordered table-condensed table-hover table-responsive" style="width:100%;">
                        <thead class="bg-blue-active">
                          ...
                          <th style="text-align:center; width:140px;" class="nd">Código</th>
                          ...
                          <th style="text-align:right; width:120px;" class="nd">Precio Und</th>
                          <th style="text-align:right; width:130px;" class="nd">Sub Total</th>
                          <th style="text-align:right; width:28px;" class="nd">Imp.</th>
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <input type="control" name="idventa" id="idventa" class="hidden">
                    <input type="control" name="idventaop" id="idventaop" class="hidden">
                    <input type="control" name="idcliente" id="idcliente" class="hidden">
                    <input type="control" name="idcondpago" id="idcondpago" class="hidden">
                    <input type="control" name="idvendedor" id="idvendedor" class="hidden">
                    ...
                    <input type="hidden" name="tipo" id="tipo" value="Pedido" class="hidden">
                  </div>
