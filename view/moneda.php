         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Monedas </h1><br>
              ...
              <div class="panel-body table-responsive hidden" id="listadoregistros">
                <table id="tblistado" class="table compact table-striped table-bordered table-condensed table-hover" style="width:100% !important;">
                  <thead class="bg-gray-active">
                    ...
                    <th>Descripción</th>
                    <th class="text-center" style="width:100px">M.Base</th>
                    <th class="text-center" style="width:100px">Factor</th>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <label for="cod_moneda">Codigo:</label>
                    <input type="hidden" name="idmoneda" id="idmoneda">
                    <input type="textc" name="cod_moneda" id="cod_moneda" class="form-control" placeholder="Codigo" required="required" >
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 no-margin">
                  </div>
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <label for="desc_moneda">Descripción:</label>
                    <input type="text" name="desc_moneda" id="desc_moneda" class="form-control" 
                    required="required" maxlength="250" placeholder="Descripción">
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 no-margin">
                  </div>
                  <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <label class="checkbox-inline"><input type="checkbox" id="base" name="base">: Es Moneda Base </label>   
                  </div>
                  <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <span class="input-group-addon"><label>Factor de Cambio:</label></span>
                      <input type="text" id="factor" name="factor" class="form-control numberf" style="text-align:right;">
                    </div>
                  </div>
