         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Tipos de Proveedores </h1><br>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <label for="cod_tipoproveedor">Codigo:</label>
                    <input type="hidden" name="idtipoproveedor" id="idtipoproveedor">
                    <input type="textc" name="cod_tipoproveedor" id="cod_tipoproveedor" class="form-control" 
                    placeholder="Codigo" required="required">
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  </div>
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <label for="desc_tipoproveedor">Descripción:</label>
                    <input type="text" name="desc_tipoproveedor" id="desc_tipoproveedor" class="form-control" 
