         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Condición de Pago </h1><br>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <label for="cod_condpago">Codigo:</label>
                    <input type="hidden" name="idcondpago" id="idcondpago">
                    <input type="textc" name="cod_condpago" id="cod_condpago" class="form-control" placeholder="Codigo" required="required" >
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  </div>
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <label for="desc_condpago">Descripción:</label>
                    <input type="text" name="desc_condpago" id="desc_condpago" class="form-control" 
                  ...
                  <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <span class="input-group-addon"><label>Dias de Plazo:</label></span>
                      <input type="text" id="dias" name="dias" class="form-control numberf" style="text-align:right;">
                    </div>
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/condpago.js"></script>
<?php 
}
ob_end_flush();
?>