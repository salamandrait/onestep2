         ...
         <div class="col-md-12">
            <div class="box">
               ...
               <div class="box-header with-border box-primary"><!-- box header-->
                  <h1 class="box-title"> Bancos </h1><br>
              ...
              <div class="panel-body hidden" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6 no-padr">
                    <label for="cod_banco">Codigo:</label>
                    <input type="hidden" name="idbanco" id="idbanco">
                    <input type="textc" name="cod_banco" id="cod_banco" class="form-control" placeholder="Codigo" required="required" >
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12 no-padl">
                    <label>Moneda:</label>     
                    <select name="idmoneda" id="idmoneda" class="form-control nice-select" data-live-search="true">
                    </select>   
                  </div>
                  <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <label for="desc_banco">Descripción:</label>
                    <input type="text" name="desc_banco" id="desc_banco" class="form-control" 
                    required="required" maxlength="250" placeholder="Descripción">
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad no-margin">
                  </div>
                  ...
                  <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
                    ...
                    <input type="number" class="form-control" name="plazo1" id="plazo1" placeholder="Misma Plaza">
                  </div>
                  <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
                    <label>Otra Plaza:</label>
                    <input type="number" class="form-control" name="plazo2" id="plazo2" placeholder="Otra Plaza">
                  </div> 
